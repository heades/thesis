...
% example
%\documentclass[phd,appendix,dedicationpage,ackpage,epigraphpage,figures,abstractpage]{uithesis}
\documentclass[phd,dedicationpage,ackpage,epigraphpage,figures]{uithesis}
...
\renewcommand{\cfttoctitlefont}{\vspace{5px}\hfill\normalsize\normalfont}
...
\cftsetindents{chapter}{0.25in}{0.5in}
\cftsetindents{section}{0.5in}{0.5in}
\cftsetindents{subsection}{0.75in}{0.5in}

\setlength{\cftbeforepartskip}{14.48pt}
\setlength{\cftbeforechapskip}{14.48pt}
\setlength{\cftbeforetoctitleskip}{-16pt}
\setlength\cftafterloftitleskip{0pt}
\setlength\cftbeforeloftitleskip{-19pt}

% Disables the box around hypperef links.
\hypersetup{
    colorlinks=true,
    linkcolor=black,
    citecolor=black,
...
% Figure separation lengths.
\setlength{\textfloatsep}{70px}
\setlength{\intextsep}{70px}
\setlength{\floatsep}{70px}
...
\addtocontents{toc}{\vskip -0.9cm} 

\frontmatter

\chapter*{\normalfont Introduction \vspace{15px}}
\label{sec:introduction}
\addcontentsline{toc}{listhead}{INTRODUCTION}
...
\addcontentsline{toc}{listhead}{CONCLUSION}
...
% \addcontentsline{toc}{listhead}{APPENDIX}
