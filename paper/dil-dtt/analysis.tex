...
Along the way, we will see admissibility of the analogs of the rules
...
\begin{lemma}[Node Substitution for Reachability]
...
\begin{lemma}[Node Substitution for Typing]
