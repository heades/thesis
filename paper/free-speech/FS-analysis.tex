...
\end{proof} 
The second result is regularity, which insures that if an expression has a
 ...
 $\Gamma,[v/x]\Gamma' \tvdash{\theta'} \arrowT{y}{\theta''}{[v/x]e'_1}{\epsilon}{[v/x]e_2}:[[Type]]$,
  ...
  \item[Case.]\ \\
   ...
   \item[Case.]\ \\
     ...
     by applying \\
     $\FSdrulename{Lam}$, $\Gamma, [v/x]\Gamma' \tvdash{\theta'} 
...
needed to prove the case for \FSdrulename{AppPiTerm} in the proof of
