\subsection{The inversion lemma}
...
\begin{proof}
  ...
  \end{itemize}
\end{proof}
% subsection the_inversion_lemma (end)
...
% subsection type_preservation (end)
...
\begin{definition}
  \label{def:FS-interp}
  Let $J = \{e\ |\ e \join join \vee e \join injdom \vee e \join injran\}$.  We define the 
interpretation of types as follows:\\
...
% subsection interpretation_of_types (end)
...
\begin{proof}
  ...
  \end{itemize}
\end{proof}
% subsection critical_properties (end)
...
\end{itemize}
\end{proof}
% subsection type_soundness (end)
% subsection logical_consistency (end)