...
is how we carve out the logical fragment from the programmatic, and
the stage annotation implements the second feature above where all
programs annotated with a $[[-]]$ will be erased after compile time.
...
equations denoted $[[e1 = e1]]$, the successor function denoted
$[[S]]$, the natural number zero denoted $[[Z]]$,
