...
predicativity\index{Predicativity} -- from his type theories he added a second level of
...
rules for SSF are defined in Figure~\ref{fig:SSF_syntax}, kinding rules
in Figure~\ref{fig:SSF_kinding}, and typing rules in
Figure~\ref{fig:SSF_typing}.
\begin{figure}[ht]
  \index{Stratified System F (SSF)}
  \begin{center}
    \begin{tabular}{lll}
      Syntax: 
      \vspace{10px} \\
