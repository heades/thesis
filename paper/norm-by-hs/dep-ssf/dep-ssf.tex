...
programming languages, such as the \textsc{Guru}
...
Fig.~\ref{fig:syntax_ssfe}.  The kind-assignment rules are defined in
...
Fig.~\ref{fig:typing_rules_ssfe}.  Note that $t_1 \join t_2$ denotes
