...
\subsubsection{Free Symmetric Monoidal Categories}
...
% subsubsection free_symmetric_monoidal_categories (end)

% subsection monoidal_categories (end)
...
\begin{definition}
  ...
  \end{center}
\end{definition}
% subsection monads_and_comonads (end)
